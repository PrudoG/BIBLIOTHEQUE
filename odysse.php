...
<head>
    ...
    <link rel="stylesheet" href="odyssee.css">
    <title>Odyssée Littéraire</title>
</head>
<body>
  <!-- navbar   -->
  ...
  <div class="container">
        ...
        <div class="collapse navbar-collapse mt-3" id="navbarIcons">
            <ul class="navbar-nav  me-auto mb-2 mb-lg-0 mx-auto ">
                <li class="nav-item ">
                    <a class="nav-link active text-warning liens" aria-current="page" href="#">Accueil</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white liens" href="noslivres.php">Livres</a>
                </li>
                <li class="nav-item">
...
<section>
        ...
        <div id="carouselExampleIndicators" class="carousel slide shadow h-100" data-bs-ride="carousel" data-bs-touch="true">
            ...
            <div class="carousel-inner h-100 ">
                <div class="carousel-item active ">
                    <img src="bibliotheque/IMG_2598.JPG" class="d-block img-fluid w-100  " alt="...">
                </div>
                <div class="carousel-item h-100 ">
                    <img src="bibliotheque/accueil.jpg" class="d-block img-fluid w-100 " alt="...">
                </div>
                <div class="carousel-item  h-100">
                    <img src="bibliotheque/enfin.jpg" class="d-block img-fluid w-100 " alt="...">
                </div>
            </div>
...
<section>   
    <div class="container mt-5">
        <h1 class="">Nos livres</h1>
        <p class="fw-bold">Pour ne rien manquer des dernières sorties et celles d'avenir!</p>
        <div class="row  g-4">
            <div class="col-6 col-md-3 col-lg-3">
                <div class="card h-100">
                    <img src="images livre/COMPRENDRE L'ECONOMIE ET LA FINANCE.webp" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">title livre</h5>
                        <p class="card-text">categories</p>
                        <p class="card-text ">Auteur</p>
                        <p class="card-text mt-3">Liens vers le livres</p>
                    </div>
                </div>
            </div>
            <div class="col-6 col-md-3 col-lg-3">
